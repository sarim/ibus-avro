var db =
{
    ...
    "chand": "ca^d",
    "chandan": "condon",
    "chandannagar": "condon`nogor",
    "chandennagore": "condon`nogor",
    "chandra": "condro",
    "chandradeep": "condrodIp",
    "chandu": "ca^du",
    "channel": "cyanel",
    "chara": "chaRa",
    "character": "kyarekTar",
    ...
    "chokkagoje": "chok`kagoje",
    "chokkagojer": "chok`kagojer",
    "chokkaTa": "chok`kaTa",
    "chokkaTO": "chok",
    "chokkaTun": "chok",
    "cikmik": "cik`mik",
    ...
    "comrI": "com`rI",
    "condonkaShTho": "condon`kaShTho",
    "condonkaTh": "condon`kaTh",
    "condonkaThe": "condon`kaThe",
    "condonkaTher": "condon`kaTher",
    "condontilok": "condon`tilok",
    "conductor": "konDakTor",
    ...
    "portable": "pOrrTeb`l",
    "portugal": "porrtugal",
    "poScimbonge": "poScim`bonge",
    "poScimbongei": "poScim`bongei",
    "poScimbonger": "poScim`bonger",
    "poScimbongo": "poScim`bongo",
    "poshcimbangla": "poshcim`bangla",
    "poshcimbanglar": "poshcim`banglar",
    "poshcimbanglate": "poshcim`banglate",
    "poshcimbanglay": "poshcim`banglay",
    "poshcimbonge": "poshcim`bonge",
    "poshcimbongei": "poshcim`bongei",
    "poshcimbonger": "poshcim`bonger",
    ...
    "talgach": "tal`gach",
    "talgache": "tal`gache",
    "talgachgulO": "tal`gachgulO",
    "talgachTa": "tal`gachTa",
    "talgachTai": "tal`gachTai",
    "talgachTay": "tal`gachTay",
    "talk": "Tk",
    "talkana": "tal`kana",
    "talkanar": "tal`kanar",
